...
if __name__ == '__main__':
    ...
    identifier = 'ann_'+architecture.lower()+'_'+dataset.lower()+'_'+store_name.lower()
    ...
    if architecture[0:3].lower() == 'vgg':
        ...
        if architecture.lower() == 'resnet12':
            model = ResNet12(labels=labels, dropout=dropout,batch_flag=batch_flag)
        elif architecture.lower() == 'resnet20':
            model = ResNet20(labels=labels, dropout=dropout,batch_flag=batch_flag)
        elif architecture.lower() == 'resnet34':
            model = ResNet34(labels=labels, dropout=dropout,batch_flag=batch_flag) 
    #f.write('\n{}'.format(model))

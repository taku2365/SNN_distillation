...
def test(epoch):
    ...
    with torch.no_grad():
        ...
        test_loss = metric_average(losses.avg, 'avg_loss')
        test_accuracy = metric_average(top1.avg, 'avg_accuracy')
...
if __name__ == '__main__':
    ...
    if dataset == 'CIFAR10':
        trainset    = datasets.CIFAR10(root = './cifar_data-%d'.format(hvd.rank()), train = True, download = True, transform = transform_train)
